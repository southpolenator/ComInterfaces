...
{
    /// <summary>
    /// Helper enumeration for easier handling return values from COM interfaces.
    /// </summary>
    ...
    /// <summary>
    /// Some useful extension methods for <see cref="HResult"/> enumeration.
    /// </summary>
    public static class HResultExtensions
    {
        /// <summary>
        /// Converts <code>int</code> to <see cref="HResult"/>.
        /// </summary>
        /// <param name="value">Integer value that represents <see cref="HResult"/></param>
        /// <returns>Converted <see cref="HResult"/> value.</returns>
        public static HResult ToHResult(this int value)
        {
            return (HResult)value;
        }

        /// <summary>
        /// Checks if <see cref="HResult"/> is failure code.
        /// </summary>
        /// <param name="value"></param>
        /// <returns><c>true</c> if <see cref="HResult"/> has failure code.</returns>
        public static bool IsFailure(this HResult value)
        {
            return (0x80000000 & (uint)value) == 0x80000000;
        }

        /// <summary>
        /// Checks if <see cref="HResult"/> is not failure code.
        /// </summary>
        /// <param name="value"></param>
        /// <returns><c>false</c> if <see cref="HResult"/> has failure code.</returns>
        public static bool IsSuccess(this HResult value)
        {
