...
namespace DIA.NoExceptions
{
    ...
    public interface IDiaSymbol
    {
        ...
        /// <param name="ppResult">Returns the undecorated name for a C++ decorated name.</param>
        [PreserveSig]
        HResult get_undecoratedNameEx(
            [In] UndecoratedNameOptions undecorateOptions,
            [Out, MarshalAs(UnmanagedType.BStr)] out string ppResult);
        ...
        /// <param name="isect">Specifies the section component of the address.</param>
        /// <param name="offset">Specifies the offset component of the address.</param>
        /// <param name="ppResult">Holds an <see cref="IDiaEnumSymbols"/> object that contains the list of frames that are retrieved.</param>
        [PreserveSig]
        ...
        /// </summary>
        /// <param name="ppResult">Holds an <see cref="IDiaEnumLineNumbers"/> object that contains the list of line numbers that are retrieved.</param>
        [PreserveSig]
        ...
        /// </summary>
        /// <param name="ppResult">A <see cref="IDiaLineNumber"/> object that contains the source file and line number where the user-defined.</param>
        [PreserveSig]
