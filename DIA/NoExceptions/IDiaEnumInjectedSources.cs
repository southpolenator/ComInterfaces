...
namespace DIA.NoExceptions
{
    ...
    public interface IDiaEnumInjectedSources
    {
        ...
        /// <param name="injectedSource">Returns an <see cref="IDiaInjectedSource"/> object representing the injected source.</param>
        [PreserveSig]
        HResult Item(
            [In] uint index,
        ...
        /// </summary>
        /// <param name="ppenum">Returns an <see cref="IDiaEnumInjectedSources"/> object that contains a duplicate of the enumerator. The injected sources are not duplicated, only the enumerator.</param>
        [PreserveSig]
        HResult Clone(
